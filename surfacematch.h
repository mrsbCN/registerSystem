...
public:
    ...
    void
    match(HTuple &hv_ObjectScene3D, double RelSamplingDistance, double KeyPointFraction, HTuple &Pose, HTuple &Score);
...
private:
    ...
    HTuple hv_SurfaceModelID,hv_ObjectScene3DClone, hv_Status1;
...
signals:
    void registerComplete(double Pose, double Score);
